...
const fileName = photo?.name;
  ...
  return (
    <div>
      ...
      <AuthFont>대학원 선배 회원으로 가입하면 멘토링을 진행할 수 있어요</AuthFont>
      <br />
      <AuthImgBox>
        <Image
        width={233}
      ...
      <AuthComment>
        <li id='auth-msg'>대학원생임을 증명할 수 있는 사진을 첨부해주세요.</li>
        <div id ='auth-msg-color'> (대학원 학생증, 대학원 합격증, 연구실멤버 확인 캡쳐본 등)</div>
        <li id='auth-msg'>첨부한 사진은 대학원 선배 회원 승인 후에 폐기됩니다.</li>
      ...
      />
      </APhotoIn>:<Photo type='auth'handler={setPhoto} /> }
      {uploadFlag && (
        <SingleValidator
          textColor="#FF0000"
      ...
      <AuthBtn getPhoto={!!photo} onClick={handleClick}>다음으로</AuthBtn>
    </div>
  );
}
