  ...
  return (
    <div>
      <div style={{ display: 'flex' }}>
        <TapStyle onClick={() => handleTabClick(SFTAB.AI)}>인공지능</TapStyle>
        <TapStyle onClick={() => handleTabClick(SFTAB.CD)}>반도체</TapStyle>
        <TapStyle onClick={() => handleTabClick(SFTAB.BI)}>바이오</TapStyle>
        <TapStyle onClick={() => handleTabClick(SFTAB.AG)}>에너지</TapStyle>
        <TapStyle onClick={() => handleTabClick(SFTAB.OT)}>다른분야</TapStyle>
      </div>
    </div>
  );
}
