...
function PhoneNumForm() {
  ...
  return (
    <div>
      <h3>휴대번호를 입력해주세요</h3>
      <PhoneNumContainer>
        <input type="text" id="phone-num-input-fir" className="phone-num-input" onChange={(e) => checkPhoneNum(e)} />
        <div>-</div>
        <input type="text" id="phone-num-input-sec" className="phone-num-input" onChange={(e) => checkPhoneNum(e)} />
        <div>-</div>
        <input type="text" id="phone-num-input-thi" className="phone-num-input" onChange={(e) => checkPhoneNum(e)} />
      </PhoneNumContainer>
