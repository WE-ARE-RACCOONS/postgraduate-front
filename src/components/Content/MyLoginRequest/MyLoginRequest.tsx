  ...
  return (
    <MyLoginRequestBox>
      ...
      <MLBoxBottom>
        ...
        <div id= 'mylogin-req-msg-large' ><div id= 'mylogin-req-msg-bold'>대학원 김선배</div>입니다</div>

        <div id= 'mylogin-req-msg-small'><div id= 'mylogin-req-msg-color'>진학고민,연구실꿀팁, 대학원생활이야기</div>까지</div>
        <div id= 'mylogin-req-msg-small'>당신의 고민을 해결해드릴 멘토를 찾아드릴게요!</div>
      </MLBoxBottom>
