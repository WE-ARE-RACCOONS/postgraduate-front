...
function SuggestModal({ modalHandler }: { modalHandler: () => void }) {
  ...
  return (
    <div>
      <Image id="x-icon" src={x_icon} alt="X 버튼" onClick={modalHandler} width={21} height={21} style={{marginLeft:'19rem',marginTop:'1rem'}}/>
      ...
      <h3>멘토링 진행을 위해서<br/>
        ...
        <NextBtn  btnText='내프로필 작성하기'kind='route' onClick={infoHandler}/>
        </div>
      </div>
